						...
						<div class="camera_caption">
							<div class="main-container">
								<div class="container">
									...
									<h1 class="wow fadeInUp animated">La vida <br>Es una fiesta!!</h1>
									<p class="wow fadeInUp animated"><p class="wow fadeInUp animated">Ven!! <br> Y disfruta de la mejor noche de tu vida!! </p>
									<div class="center">
